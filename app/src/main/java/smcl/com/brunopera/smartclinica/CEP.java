...
public class CEP extends AppCompatActivity {
    ...
    private void openMic(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Olá, diga seu CEP");
            ...
            case REQ_CODE_SPEECH_OUTPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    try {
                        ...
                        editCEP.setText(voiceInText.get(0));
    ...
    public void editarCEP(View view){
    ...
    public void proximaTela(View view) {
        ...
        ConexaoBD cbd = new ConexaoBD();
        cbd.inserirCEP(editCEP.getText().toString());


        Intent myIntent = new Intent(getApplicationContext(), Telefone.class);
