...
public class Telefone extends AppCompatActivity {
    ...
    private void openMic(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Olá, diga seu Telefone");
            ...
            case REQ_CODE_SPEECH_OUTPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    try {
                        ...
                        editTelefone.setText(voiceInText.get(0));
    ...
    public void editarTelefone(View view){
    ...
    public void proximaTela(View view) {
        ...
        ConexaoBD cbd = new ConexaoBD();
        cbd.inserirTelefone(editTelefone.getText().toString());


        Intent myIntent = new Intent(getApplicationContext(), Celular.class);
