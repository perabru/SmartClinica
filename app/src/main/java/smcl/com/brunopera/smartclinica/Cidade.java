...
public class Cidade extends AppCompatActivity {
    ...
    private void openMic(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Olá, diga sua Cidade");
            ...
            case REQ_CODE_SPEECH_OUTPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    try {
                        ...
                        editCidade.setText(voiceInText.get(0));
    ...
    public void proximaTela(View view) {
        ...
        ConexaoBD cbd = new ConexaoBD();
        cbd.inserirCidade(editCidade.getText().toString());


        Intent myIntent = new Intent(getApplicationContext(), CEP.class);
