...
public class Endereco extends AppCompatActivity {
    ...
    private void openMic(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Olá, diga seu Endereço");
            ...
            case REQ_CODE_SPEECH_OUTPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    try {
                        ...
                        editEndereco.setText(voiceInText.get(0));
    ...
    public void proximaTela(View view) {
        ...
        ConexaoBD cbd = new ConexaoBD();
        cbd.inserirEndereco(editEndereco.getText().toString());


        Intent myIntent = new Intent(getApplicationContext(), Bairro.class);
