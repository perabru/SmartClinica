...
public class Bairro extends AppCompatActivity {
    ...
    private void openMic(){
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Olá, diga seu Bairro");
            ...
            case REQ_CODE_SPEECH_OUTPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    try {
                        ...
                        editBairro.setText(voiceInText.get(0));
    ...
    public void editarBairro(View view){
    ...
    public void proximaTela(View view) {
        ...
        ConexaoBD cbd = new ConexaoBD();
        cbd.inserirBairro(editBairro.getText().toString());
